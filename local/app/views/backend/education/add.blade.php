...
<div class="row">
    ...
    <div class="portlet-body form">
     <form class="form-horizontal" role="form" method="POST" action="{{ URL::route('admin-add-education')}}">
      <div class="form-body">
     ...
     <div class="form-group">
      ...
      <div class="col-md-9">
       <input type="number"  required name="start_year" class="form-control" placeholder="Enter Start Year">
   ...
   <div class="form-group">
    ...
    <div class="col-md-9">
     <input type="number" required  name="end_year" class="form-control" placeholder="Enter Title">
 ...
 <div class="form-group">
  ...
  <div class="col-md-9">
   <input type="text"  required  name="university" class="form-control"  placeholder="Enter University Name">
...
<div class="form-group">
  ...
  <div class="col-md-9">
   <input type="text"  required  name="achievments_title" class="form-control"  placeholder="Enter Achievment Title">
...
<div class="form-group">
  ...
  <div class="col-md-8">
   <input type="text"  required  name="achievment[]" class="form-control"  placeholder="Enter Achievment Title">
